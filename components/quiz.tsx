...
const perfumeRecommendations: { [key: string]: { name: string; image: string; type: string; brand: string }[] } = {
  'Floral-Suave-Diário': [
    { name: 'J\'ADORE', image: '/images/jadore.png', type: 'Feminino', brand: 'Dior' },
    { name: 'YARA', image: '/images/imagem-2025-11-14-191600858.png', type: 'Feminino', brand: 'Lataffa' },
    { name: 'MONT BLANC FEMME', image: '/images/imagem-2025-11-14-201354979.png', type: 'Feminino', brand: 'Mont Blanc' },
  ],
  'Amadeirado-Forte-Noite': [
    ...
    { name: 'HACIVAT', image: '/images/hacivat.png', type: 'Unissex', brand: 'Nishane' },
  ],
