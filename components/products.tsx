      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-sm md:text-base text-muted-foreground font-lato">
            Fragrâncias inspiradas. Criados pela Essence Verte.
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="p-4 md:p-6">
                ...
                {/* Description */}
                <div className="mb-6">
                  <p className="text-xs font-semibold text-secondary uppercase tracking-wide mb-2">Inspiração</p>
                  <p className="text-sm md:text-base text-primary font-playfair font-semibold mb-3">
                    {selectedProduct.name}
                  </p>
                  <p className="text-sm md:text-base text-foreground leading-relaxed font-lato">
